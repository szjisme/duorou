			...
			<view class="phone-list">
				<view class="list-item" v-for="(item, key) of phones" :key="key" :id="key">
					...
					<view
						...
						:key="innerItem.id"
						:data-name="innerItem.encyclopedia_name"
						:data-src="innerItem.encyclopedia_thumb"
						:data-id="innerItem.encyclopedia_id"
					>	
					<image 
						class="head-img" 
						src="" v-bind:src="innerItem.encyclopedia_thumb" 						
						:data-id="innerItem.encyclopedia_id"
						mode=""
						>
						</image>
						{{ innerItem.encyclopedia_name }}
					</view>
				</view>
			</view>
		</scroll-view>
